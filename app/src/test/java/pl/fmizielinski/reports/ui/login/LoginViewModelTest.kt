...
class LoginViewModelTest {
    ...
    @Test
    fun `WHEN no credentials passed THEN disable login button`() = runTest {
    ...
    @Test
    fun `WHEN no email passed THEN disable login button`() = runTest {
        val viewModel = viewModel(testScheduler)
    ...
    @Test
    fun `WHEN no password passed THEN disable login button`() = runTest {
        val viewModel = viewModel(testScheduler)
    ...
    @Test
    fun `WHEN email and password passed THEN enable login button`() = runTest {
        val viewModel = viewModel(testScheduler)
    ...
    @Test
    fun `GIVEN valid credentials WHEN login clicked THEN disable login button AND clear password`() = runTest {
        val email = "email"
    ...
    @Test
    fun `GIVEN valid credentials WHEN login clicked AND login error THEN show snackbar AND clear password`() = runTest {
        val email = "email"
        val password = "password"
    ...
    @Test
    fun `GIVEN password passed WHEN show password clicked THEN toggle show password`() = runTest {
        val viewModel = viewModel(testScheduler)
